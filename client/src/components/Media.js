    ...
    return (
      <div className="media">
          ...
          <CardContent className={classes.content}>
            ...
            <div>
              <iframe
                ...
                src={`https://www.youtube.com/embed/${
                  debate.indexOf("=") > -1 ? debate.split("=")[1] : debate
                }`}
                frameBorder="0"
            ...
            <div className="reactions">
              <div className="reaction">
                <ThumbUpIcon
                  onClick={() =>
                    this.handleLike(_id, likes, this.props.user.email)
                  }
                />
                <span className="reaction_count">{likes}</span>
              </div>
              <div className="reaction">
                <ThumbDownAltIcon
                  onClick={() =>
                    this.handleDislike(_id, dislikes, this.props.user.email)
                  }
                />
                <span className="reaction_count">{dislikes}</span>
              </div>
            </div>
        ...
        <div className="replyBtn">
          <Link to={`/memebate/${_id}`} className="btn">
            Reply
          </Link>
        </div>
